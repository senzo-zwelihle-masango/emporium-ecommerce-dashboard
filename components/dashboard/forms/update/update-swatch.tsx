...
import { updateSwatchAction } from '@/server/actions/dashboard/swatch'
...
const UpdateSwatchForm = ({ swatch }: UpdateSwatchFormProps) => {
  ...
  function onSubmit(values: SwatchSchemaType) {
    startTransition(async () => {
      const { data: result, error } = await tryCatch(updateSwatchAction(values, swatch.id))
      ...
      if (result.status === 'success') {
        ...
        router.push(`/dashboard/products/${swatch.productId}`)
