...
import { createBillboardAction } from '@/server/actions/dashboard/billboard'
...
const CreateBillboardForm = ({ categories, products }: CreateNewBillboardProps) => {
  // Form states
  ...
  function onSubmit(values: BillboardSchemaType) {
    startTransition(async () => {
      const { data: result, error } = await tryCatch(createBillboardAction(values))
